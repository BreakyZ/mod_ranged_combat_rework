this.legend_hip_shoot_bolt <- this.inherit("scripts/skills/skill", {
	m = {
	...
	function create()
	{
		this.m.ID = "actives.legend_hip_shoot_bolt";
		this.m.Name = "Hip Shot";
		this.m.Description = "A quick pull of the trigger to loose a bolt without much aim. Will be very innacurate in comparison with an aimed shot. Must be reloaded after each shot to be able to fire again.";
