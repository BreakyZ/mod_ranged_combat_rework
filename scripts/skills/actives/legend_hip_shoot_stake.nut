this.legend_hip_shoot_stake <- this.inherit("scripts/skills/skill", {
	m = {
		AdditionalAccuracy = -35,
	...
	function create()
	{
		...
		this.m.Description = "A quick pull of the trigger to loose a heavy bolt without much aim. Will be very innacurate in comparison with an aimed shot. Must be reloaded after each shot to be able to fire again. Knocks targets back. Deals +100 damage to vampires";
